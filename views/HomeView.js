...
const HomeView = {
  setup() {
    ...
    const subscribed = Vue.ref(false);
    function subscribe() {
    ...
    <div>
      <!-- ヒーローセクション with 動画背景 -->
        ...
        <video autoplay muted loop playsinline 
            ...
            type="video/mp4" 
            />
        </video> :contentReference[oaicite:0]{index=0}
      ...
      <section class="container my-5">
        ...
        <div class="row gx-4 gy-4">
          <div class="col-md-3" v-for="(feat,i) in [
            ...
            <div class="col-md-3" v-for="(s,i) in stats" :key="i">
              ...
              <div class="progress" style="height: 1rem;">
                <div class="progress-bar bg-success" role="progressbar"
                     :style="{ width: s.value + '%' }" 
                     :aria-valuenow="s.value" aria-valuemin="0" aria-valuemax="100">
                  {{ s.value }}%
                </div>
              </div>
            </div>
      ...
      <section class="container my-5">
        ...
        <div id="testimonialCarousel" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item text-center" v-bind:class="{ active: idx===0 }" v-for="(t,idx) in [
